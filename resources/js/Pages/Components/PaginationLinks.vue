...
<div class="flex justify-between items-start">
    <div class="flex item-center rounded-md overflow-hidden shadow-lg">
    ...
    <p class="text-slate-600 text-sm">Showing {{ paginator.from }} to 
        {{ paginator.to }} of {{ paginator.total }} results
    </p>
</div>
